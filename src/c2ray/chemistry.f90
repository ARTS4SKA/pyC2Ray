...
contains
   ...
   subroutine global_pass(dt, ndens, temp, xh, xh_av, xh_intermed, phi_ion, clump, &
   ...
   subroutine evolve0D_global(dt, pos, ndens, temp, xh, xh_av, xh_intermed, phi_ion, clump, &
      ...
      yh_av_p = 1.0 - xh_av_p
      call do_chemistry(dt, ndens_p, temperature_start, xh_p, xh_av_p, xh_intermed_p, &
                        phi_ion_p, clump_p, bh00, albpow, colh0, temph0, abu_c)
