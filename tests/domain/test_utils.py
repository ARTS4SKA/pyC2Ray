...
def test_expand_enclosing_sphere_spans_both_when_neither_is_contained() -> None:
...
def test_expand_enclosing_sphere_encloses_both_inputs() -> None:
    ...
    cases = [
        ...
        ((-3.0, 1.5, 0.25, 0.75), (2.5, -4.0, 3.0, 1.25)),  # disjoint, off-axis
        ((0.0, 0.0, 0.0, 2.0), (1.0, 1.0, 1.0, 1.5)),  # overlapping, neither contained
